...
Most CI services are tightly integrated with GitHub. In this episode, we will be using [GitHub Actions](https://docs.github.com/en/free-pro-team@latest/actions),
...
In order to test our projects using Travis, we will have to set up the correct environment and tell our CI service what to do.
...
If you wanted to change the template or contributing text, you would do so by editing these files. Though not included with the cookiecutter, you can also have
