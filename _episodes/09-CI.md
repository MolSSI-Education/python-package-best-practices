...
If we use `uses,`, we are using a modular step that someone else has written and made available on the GitHub Actions Marketplace.
It then says that it uses `actions/checkout@v3`.
This is an action that checks out your project.
